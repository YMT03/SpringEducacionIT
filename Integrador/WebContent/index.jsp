...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand col-12 col-lg-1 d-flex justify-content-center" href=""><img src="sources/img/logo.png" alt="Java" height="80px"></a>  
      ...
      <ul class="navbar-nav justify-content-xl-center flex-fill col-xl-7 align-items-center ">
        ...
        <li class="nav-item ">
          <a class="nav-link" id="scroller1" href="clients/home.html">Clientes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="scroller2" href="issues">Reclamos</a>
        </li>
        <li class="nav-item ">
          <a class="nav-link" id="scroller3" href="contact">Contacto</a>
        </li>
        <li class="nav-item ">
          <a class="nav-link" id="scroller4" href="about">Acerca de nosotros</a>
        </li>
...
<header>
    <div class="row display-4 justify-content-center mb-5 mt-5" id="title"> Servicios de Internet</div>
    <div class="row mb-5 ">
  ...
  <div class="row mb-5 ">
    <div class="col-lg-4 col-sm-12 align-items-center">
      <div class="display-4 pl-3 float-left ">
        <img class="img mx-auto d-flex" src="sources/img/background.png" alt="rubiks" height="200px">
      </div>
    </div>
